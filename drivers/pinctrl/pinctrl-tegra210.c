...
#define PINGROUP(pg_name, f0, f1, f2, f3, r, od, schmitt_b, hsm_b, drvtype, e_io_hv)	\
	{							\
		...
		.einput_bank = 1,				\
		.einput_bit = 6,				\
		.e_io_hv_reg = PINGROUP_REG_##e_io_hv(r),	\
		.e_io_hv_bank = 1,				\
		.e_io_hv_bit = 10,				\
		.odrain_reg = PINGROUP_REG_##od(r),		\
		.odrain_bank = 1,				\
		.odrain_bit = 11,				\
		.drvtype_reg = PINGROUP_REG_##drvtype(r),	\
		.drvtype_bank = 1,				\
		.drvtype_bit = 13,				\
		.drvtype_width = 2,				\
...
static const struct tegra_pingroup tegra210_groups[] = {
	...
	PINGROUP(sdmmc1_clk_pm0,	SDMMC1,		RSVD1,		RSVD2,		RSVD3,		0x3000,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_cmd_pm1,	SDMMC1,		SPI3,		RSVD2,		RSVD3,		0x3004,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat3_pm2,	SDMMC1,		SPI3,		RSVD2,		RSVD3,		0x3008,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat2_pm3,	SDMMC1,		SPI3,		RSVD2,		RSVD3,		0x300c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat1_pm4,	SDMMC1,		SPI3,		RSVD2,		RSVD3,		0x3010,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat0_pm5,	SDMMC1,		RSVD1,		RSVD2,		RSVD3,		0x3014,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(pk0,			IQC0,		I2S5B,		RSVD2,		RSVD3,		0x3254,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk1,			IQC0,		I2S5B,		RSVD2,		RSVD3,		0x3258,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk3,			IQC0,		I2S5B,		RSVD2,		RSVD3,		0x3260,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk4,			IQC1,		RSVD1,		RSVD2,		RSVD3,		0x3264,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk2,			IQC0,		I2S5B,		RSVD2,		RSVD3,		0x325c,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk7,			IQC1,		RSVD1,		RSVD2,		RSVD3,		0x3270,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(core_pwr_req,		CORE,		RSVD1,		RSVD2,		RSVD3,		0x317c,  Y,	12,	-1,	N,	N),
	PINGROUP(cpu_pwr_req,		CPU,		RSVD1,		RSVD2,		RSVD3,		0x3170,  Y,	12,	-1,	N,	N),
	PINGROUP(pwr_int_n,		PMI,		RSVD1,		RSVD2,		RSVD3,		0x3174,  Y,	12,	-1,	N,	N),
	PINGROUP(clk_32k_in,		CLK,		RSVD1,		RSVD2,		RSVD3,		0x3160,  Y,	12,	-1,	N,	N),
	PINGROUP(dap1_fs_pb0,		I2S1,		RSVD1,		RSVD2,		RSVD3,		0x3124,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_din_pb1,		I2S1,		RSVD1,		RSVD2,		RSVD3,		0x3128,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_dout_pb2,		I2S1,		RSVD1,		RSVD2,		RSVD3,		0x312c,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_sclk_pb3,		I2S1,		RSVD1,		RSVD2,		RSVD3,		0x3130,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(dap2_fs_paa0,		I2S2,		RSVD1,		RSVD2,		RSVD3,		0x3134,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_din_paa2,		I2S2,		RSVD1,		RSVD2,		RSVD3,		0x3138,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_dout_paa3,	I2S2,		RSVD1,		RSVD2,		RSVD3,		0x313c,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_sclk_paa1,	I2S2,		RSVD1,		RSVD2,		RSVD3,		0x3140,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(sdmmc3_clk_pp0,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x301c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_cmd_pp1,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x3020,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat0_pp5,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x3024,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat1_pp4,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x3028,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat2_pp3,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x302c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat3_pp2,	SDMMC3,		RSVD1,		RSVD2,		RSVD3,		0x3030,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(spi1_mosi_pc0,		SPI1,		RSVD1,		RSVD2,		RSVD3,		0x3050,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_miso_pc1,		SPI1,		RSVD1,		RSVD2,		RSVD3,		0x3054,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_sck_pc2,		SPI1,		RSVD1,		RSVD2,		RSVD3,		0x3058,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_cs0_pc3,		SPI1,		RSVD1,		RSVD2,		RSVD3,		0x305c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_cs1_pc4,		SPI1,		RSVD1,		RSVD2,		RSVD3,		0x3060,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_mosi_pb4,		SPI2,		DTV,		RSVD2,		RSVD3,		0x3064,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_miso_pb5,		SPI2,		DTV,		RSVD2,		RSVD3,		0x3068,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_sck_pb6,		SPI2,		DTV,		RSVD2,		RSVD3,		0x306c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_cs0_pb7,		SPI2,		DTV,		RSVD2,		RSVD3,		0x3070,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_cs1_pdd0,		SPI2,		RSVD1,		RSVD2,		RSVD3,		0x3074,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_mosi_pc7,		SPI4,		RSVD1,		RSVD2,		RSVD3,		0x3078,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_miso_pd0,		SPI4,		RSVD1,		RSVD2,		RSVD3,		0x307c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_sck_pc5,		SPI4,		RSVD1,		RSVD2,		RSVD3,		0x3080,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_cs0_pc6,		SPI4,		RSVD1,		RSVD2,		RSVD3,		0x3084,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_sck_pee0,		QSPI,		RSVD1,		RSVD2,		RSVD3,		0x3088,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_cs_n_pee1,	QSPI,		RSVD1,		RSVD2,		RSVD3,		0x308c,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io0_pee2,		QSPI,		RSVD1,		RSVD2,		RSVD3,		0x3090,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io1_pee3,		QSPI,		RSVD1,		RSVD2,		RSVD3,		0x3094,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io2_pee4,		QSPI,		RSVD1,		RSVD2,		RSVD3,		0x3098,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io3_pee5,		QSPI,		RSVD1,		RSVD2,		RSVD3,		0x309c,  Y,	12,	 9,	Y,	N),
	...
	PINGROUP(clk_req,		SYS,		RSVD1,		RSVD2,		RSVD3,		0x316c,  Y,	12,	-1,	N,	N),
	PINGROUP(shutdown,		SHUTDOWN,	RSVD1,		RSVD2,		RSVD3,		0x3178,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(pk5,			IQC1,		RSVD1,		RSVD2,		RSVD3,		0x3268,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk6,			IQC1,		RSVD1,		RSVD2,		RSVD3,		0x326c,  Y,	12,	 9,	Y,	N),
	PINGROUP(pl0,			RSVD0,		RSVD1,		RSVD2,		RSVD3,		0x3274,  Y,	12,	 9,	Y,	N),
	PINGROUP(pl1,			SOC,		RSVD1,		RSVD2,		RSVD3,		0x3278,  Y,	12,	 9,	Y,	N),
